...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_grey,  col_grey  },
};
...
static const char *inc_volume[] = { "amixer", "-q", "set", "Master", "5%+", "unmute", NULL };
static const char *dec_volume[] = { "amixer", "-q", "set", "Master", "5%-", "unmute", NULL };
